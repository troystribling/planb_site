...
INSERT INTO `page_parts` VALUES (1,'body','','<div class=\"section-wrapper\">\r\n  <div class=\"section\">\r\n    <h1><a href=\"has_ancestor\">has_ancestor</a></h1>\r\n    <div class=\"subsection-wrapper\">\r\n      <div class=\"subsection\">\r\n	<p>\r\n          has_ancestor is a Ruby on Rails plug-in that adds two class methods to ActiveRecord::Base. The methods allow specification of inheritance relations between ActiveRecord models. With           \r\n          the method has_ancestor an ancestor relation is declared between a descendant model and its ancestor and with the method has_descendants a descendant relation is declared between an          \r\n          ancestor model and its descendants. Once ancestor and descendant relations are declared between models the models interact as would be expected from class inheritance: ancestor \r\n          instance and class methods may be called from the descendant model, this permits access to ancestor attributes from the descendant model and polymorphic methods implemented on both \r\n          ancestor and descendant may be called from the ancestor.\r\n	</p>\r\n      </div>\r\n    </div>	 \r\n    <h1><a href=\"/acts_as_aln\">acts_as_aln</a></h1>\r\n    <div class=\"subsection-wrapper\">\r\n      <div class=\"subsection\">\r\n	<p>\r\n          acts_as_aln, or Acts as Abstract Layered Network, is a Ruby on Rails plug-in that provides an infrastructure for construction of enterprise information models. The Abstract Layered\r\n          Network model is inspired by the network information models described in \r\n          <a href=\"http://www.itu.int/rec/T-REC-M.3100/en\">ITU M.3100</a>, <a href=\"http://www.tmforum.org/browse.aspx?catID=1718&linkID=32960\">TMF 814</a> and \r\n          <a href=\"http://telecom-info.telcordia.com/ido/AUX/GR_1093_TOC.i02.pdf\">Telecordia GR-1093-CORE</a> but instead of focusing on detailed and complex object and attribute modeling, \r\n          the focus of the network information models and also the focus of <a href=\"http://www.dmtf.org/standards/cim/\">the DMTF Common Information Model</a>, which attempts to develop a \r\n          detailed model of the enterprise infrastructure, acts_as_aln only models a few objects, the relations between the objects and a couple of attribute types, namely, the \r\n          information that most strongly impacts the structure of an application built on it. This greatly simplifies the information model and extends its domain of applicability. While the\r\n          other models are limited to communications networks, and enterprise hardware and software in the case of DMTF-CIM, acts_as_aln can be applied to these\r\n          domains and possibly to seemingly unrelated domains such as project management, customer relationship management, human resource management, business intelligence and financial\r\n          management.\r\n	</p>\r\n      </div>\r\n    </div>	 \r\n    <h1><a href=\"/linux-agent\">Linux Agent</a></h1>\r\n    <div class=\"subsection-wrapper\">\r\n      <div class=\"subsection\">\r\n	<p>\r\n          Linux Agent is an implementation of acts_as_aln applied to Red Hat and Debian Linux dialects. Linux Agent provides the ability to discover system resources and configuration\r\n          and report system performance using <a href=\"http://perso.orange.fr/sebastien.godard/tutorial.html\">SYSSTAT</a>.\r\n	</p>\r\n      </div>\r\n    </div>	 \r\n  </div>\r\n</div>	 \r\n',1),(2,'body','Textile','The file you were looking for could not be found.\n\nAttempted URL: @<r:attempted_url />@\n\nIt is possible that you typed the URL incorrectly or that you clicked on a bad link.\n\n\"<< Back to Home Page\":/\n',2),(14,'banner','','',1),(15,'navigation','','<ul>\r\n  <li><a href=\"/\"><strong>projects</strong></a></li>\r\n  <li><a href=\"http://plans.inplanb.com\">planning</a></li>\r\n  <li><a href=\"/about\">about</a></li>\r\n</ul>\r\n',1),(16,'body','','<div class=\"section-wrapper\">\r\n  <div class=\"section\">\r\n    <h1>Overview</h1>\r\n      <div class=\"subsection-wrapper\">\r\n        <div class=\"subsection\">\r\n	  <p>\r\n           has_ancestor is a Ruby on Rails plug-in that adds two class methods to ActiveRecord::Base. The methods allow specification of inheritance relations between ActiveRecord models. \r\n           With the method has_ancestor an ancestor relation is declared between a descendant model and its ancestor and with the method has_descendants a descendant relation is declared \r\n           between an ancestor model and its descendants. Once ancestor and descendant relations are declared between models the models interact as would be expected from class inheritance: \r\n           ancestor instance and class methods may be called from the descendant model, this permits access to ancestor attributes from the descendant model and polymorphic methods \r\n           implemented on both ancestor and descendant may be called from the ancestor.\r\n	  </p>\r\n        </div>\r\n      </div>	 \r\n    <h1>Install</h1>\r\n      <div class=\"subsection-wrapper\">\r\n        <div class=\"subsection\">\r\n	  <p>\r\n	  </p>\r\n        </div>\r\n      </div>	 \r\n    <h1>Use</h1>\r\n      <div class=\"subsection-wrapper\">\r\n        <div class=\"subsection\">\r\n	  <p>\r\n	  </p>\r\n        </div>\r\n      </div>	 \r\n    <h1>Known Issues</h1>\r\n      <div class=\"subsection-wrapper\">\r\n        <div class=\"subsection\">\r\n	  <p>\r\n	  </p>\r\n        </div>\r\n      </div>	 \r\n  </div>\r\n</div>	 \r\n',3),(18,'body','','<div class=\"section-wrapper\">\r\n  <div class=\"section\">\r\n    <h1>Project</h1>\r\n    <div class=\"subsection-wrapper\">\r\n      <div class=\"subsection\">\r\n	<p>\r\n	</p>\r\n      </div>\r\n    </div>	 \r\n  </div>\r\n</div>	 \r\n',4),(20,'banner','','<h1>has_ancestor</h1>',3),(21,'navigation','','<ul>\r\n  <li><a href=\"/\">projects</a></li>\r\n  <li><a href=\"http://plans.inplanb.com\">planning</a></li>\r\n  <li><a href=\"/about\"><strong>about</strong></a></li>\r\n</ul>\r\n',4),(22,'body','','<div class=\"section-wrapper\">\r\n  <div class=\"section\">\r\n    <h1>Overview</h1>\r\n      <div class=\"subsection-wrapper\">\r\n        <div class=\"subsection\">\r\n	  <p>\r\n          acts_as_aln, or Acts as Abstract Layered Network, is a Ruby on Rails plug-in that provides an infrastructure for construction of enterprise information models. The Abstract Layered\r\n          Network model is inspired by the network information models described in \r\n          <a href=\"http://www.itu.int/rec/T-REC-M.3100/en\">ITU M.3100</a>, <a href=\"http://www.tmforum.org/browse.aspx?catID=1718&linkID=32960\">TMF 814</a> and \r\n          <a href=\"http://telecom-info.telcordia.com/ido/AUX/GR_1093_TOC.i02.pdf\">Telecordia GR-1093-CORE</a> but instead of focusing on detailed and complex object and attribute modeling, \r\n          the focus of the network information models and also the focus of <a href=\"http://www.dmtf.org/standards/cim/\">the DMTF Common Information Model</a>, which attempts to develop a \r\n          detailed model of the enterprise infrastructure, acts_as_aln only models a few objects, the relations between the objects and a couple of attribute types, namely, the \r\n          information that most strongly impacts the structure of an application built on it. This greatly simplifies the information model and extends its domain of applicability. While the\r\n          other models are limited to communications networks, and enterprise hardware and software in the case of DMTF-CIM, acts_as_aln can be applied to these\r\n          domains and possibly to seemingly unrelated domains such as project management, customer relationship management, human resource management, business intelligence and financial\r\n          management.\r\n	  </p>\r\n        </div>\r\n      </div>	 \r\n  </div>\r\n</div>	 \r\n',5),(23,'banner','','<h1>acts_as_aln</h1>',5),(24,'banner','','<h1>Linux Agent</h1>',6),(25,'body','','<div class=\"section-wrapper\">\r\n  <div class=\"section\">\r\n    <h1>Overview</h1>\r\n      <div class=\"subsection-wrapper\">\r\n        <div class=\"subsection\">\r\n	  <p>\r\n          Linux Agent is an implementation of acts_as_aln applied to Red Hat and Debian Linux dialects. Linux Agent provides the ability to discover system resources and configuration\r\n          and report system performance using <a href=\"http://perso.orange.fr/sebastien.godard/tutorial.html\">SYSSTAT</a>.\r\n	  </p>\r\n        </div>\r\n      </div>	 \r\n  </div>\r\n</div>	 \r\n',6);
UNLOCK TABLES;
...
INSERT INTO `pages` VALUES (1,'Plan-B','/','Projects','Page',100,NULL,4,'2007-05-27 16:16:36','2007-06-11 01:59:12','2007-05-27 12:16:36',1,1,0,43),(2,'File Not Found','file-not-found','File Not Found','FileNotFoundPage',100,1,NULL,'2007-05-27 16:16:36','2007-05-27 16:16:36','2007-05-27 12:16:36',1,NULL,1,0),(3,'has_ancestor','has_ancestor','has_ancestor','Page',100,1,4,'2007-06-10 03:44:27','2007-06-11 02:23:45','2007-06-10 03:44:27',1,1,0,3),(4,'about','about','about','Page',100,1,4,'2007-06-10 03:44:40','2007-06-10 16:05:00','2007-06-10 03:52:20',1,1,0,5),(5,'acts_as_aln','acts_as_aln','acts_as_aln','Page',100,1,4,'2007-06-10 17:23:25','2007-06-11 01:59:39','2007-06-10 17:25:13',1,1,0,4),(6,'Linux Agent','linux-agent','Linux Agent','Page',100,1,4,'2007-06-11 01:26:50','2007-06-11 02:00:18','2007-06-11 01:43:05',1,1,0,2);
UNLOCK TABLES;
